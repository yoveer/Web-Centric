...
<?php
    ...
    if(isset($_GET['act']) && $_GET['act']=='ban'){
        ...
        $sql = "UPDATE User SET Ban='1' WHERE UserID='$ID' AND type='admin'";
        $result = $conn->query($sql);

        if ($result) {
            echo "<div class='alert alert-success' role='success'>";
            echo "<center>Ban from admin successful</center>";
            echo "</div>";
            unlink($name);
        }
        else {
...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div>
                <center><h2>Flag/Ban Admin</h2></center>
                <div class="table-responsive">
                    <form  action="<?php echo $_SERVER["PHP_SELF"];?>" method="post">
                        <table class="table table-bordered table-dark table-hover">
                            ...
                            <tbody>
                                <?php
                                    $sql = "SELECT * FROM User WHERE type='admin' AND Ban='0'";
                                    $Result = $conn->query($sql);
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href='AdminBanAdmin.php?act=ban&id=<?php echo $UID; ?>' onclick="confirm('Are you sure you want to delete this?')"><img alt="Ban" src="images/cart/remove.png"></a>
                                        </td>
                                    </tr>
                                <?php
                                    }
