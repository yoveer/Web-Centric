	...
	<script>
		$(document).ready(function() {
			$("button#getHouses").click(function() {
				//Set up an AJAX call to http://localhost/Web-Centric/CRUD_HTA/house/list/?address=, passing the owner id as parameter
				...
				var url = "http://localhost/Web-Centric/CRUD_HTA/supplier/list/";
				if (address != "") {
			...
			$("button#createHouse").click(function() {
				//Set up an AJAX call to http://localhost/Web-Centric/CRUD_HTA/house/create/

				var url = "http://localhost/Web-Centric/CRUD_HTA/supplier/create/";
