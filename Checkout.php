...
<body>
    ...
    if (@$_GET['changedatabase'] == 'true') {
        $sql = "UPDATE Cartproduct, Product, User SET Confirmation='1' WHERE Cartproduct.ProductID = Product.ProductID AND Cartproduct.UserID = User.UserID AND Cartproduct.UserID = '$UID' AND Confirmation='0'";
                ...
                <div class="table-responsive-sm">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php
                            $counter = 1;
                            $sql = "SELECT * FROM Cartproduct, Product, User WHERE Cartproduct.ProductID = Product.ProductID AND Cartproduct.UserID = User.UserID AND Cartproduct.UserID = '$UID' AND Confirmation='1'";
                            $Result = $conn->query($sql);
